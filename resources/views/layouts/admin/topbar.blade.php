...
<div id="kt_app_header" class="app-header bg-white sticky-top">
    ...
    <div class="w-100 d-none d-lg-flex m-auto justify-content-center" id="">
        ...
        <a href="{{ route('student.single_package_course', ['id' => $courseId]) }}" class="btn btn-outline-light">Courses</a>
    ...
    <div class="d-block d-lg-none d-flex align-items-center justify-content-end m-auto me-5"
                ...
                <a href="javascript:void(0);" id="notification-toggle-mobile"
                    ...
                    @if ($unreadCount > 0)
                        <i class="fa fa-bell " aria-hidden="true" style="font-size: 25px; color: #000;">
                            <span class="badge position-absolute top-0 start-50 translate-middle-x rounded-circle"
    ...
    <div class="app-navbar-item ms-1 me-md-4 d-block m-auto" id="kt_header_user_menu_toggle" >
        <!--begin::Menu wrapper-->
        <div class="cursor-pointer symbol symbol-35px" data-kt-menu-trigger="{default: 'click', lg: 'hover'}"
            data-kt-menu-attach="parent" data-kt-menu-placement="bottom-end">
            <img src="{{ asset('profile-image/' . Auth::user()->profile_photo_path) }}" class="rounded-3" alt="user">
        </div>
        ...
        <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg menu-state-color fw-semibold py-4 fs-6 w-275px"
            ...
            <div class="menu-item px-5">
                <a href="{{ Auth::user()->role == 1 ? route('users.index') : route('student-profile.index') }}" class="menu-link px-5">
                    My Profile
                </a>
            </div>
            <!--end::Menu item-->
