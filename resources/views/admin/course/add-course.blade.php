        ...
        <div id="kt_app_toolbar" class="app-toolbar py-3 py-lg-6">
            ...
            <div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
                ...
                <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
                    <!--begin::Title-->
                    <h1 class="page-heading d-flex text-dark fw-bold fs-3 flex-column justify-content-center my-0">Course
                        Management</h1>
                    <!--end::Title-->
                    <!--begin::Breadcrumb-->
            ...
            <div id="kt_app_content_container" class="app-container container-xxl">
                ...
                <div class="card mb-5 mb-xxl-8">
                    <div class="card-body pt-0  pb-0">
                        ...
                        <div>
                            <form class="Course_form form w-100" novalidate="novalidate" id="kt_sign_up_form" method="POST"
                                enctype="multipart/form-data" action="{{ route('courses.store') }}">
                                @csrf
                                <div class="row pt-6">
                                    <!-- Course Title -->
                                    <div class="col-lg-6 col-sm-12">
                                        <div class="mb-10">
                                            ...
                                            <input type="text" name="course_title"
                                                class="form-control form-control-solid" value="{{ old('course_title') }}"
                                    ...
                                    <div class="col-lg-6 col-sm-12">
                                        <div class="mb-10">
                                            ...
                                            <input type="number" name="course_seq" class="form-control form-control-solid"
                                                id="seq" required />
                                            @error('seq')
                                                <span class="error text-danger">{{ $message }}</span>
                                            @enderror
                                            ...
                                            <div class="d-flex align-items-center">
                                                ...
                                                <div class="form-check form-check-inline">
                                                    <input type="radio" name="course_type" id="free_course" value="free"
                                                        ...
                                                        {{ old('course_type') == 0 ? 'checked' : '' }} required />
                                                    <label class="form-check-label" for="free_course">Free</label>
                                                </div>
                                                <!-- Paid Course -->
                                                <div class="form-check form-check-inline">
                                                    <input type="radio" name="course_type" id="paid_course" value="paid"
                                                        checked class="form-check-input"
                                                        {{ old('course_type') == 1 ? 'checked' : '' }} required />
                                                ...
                                                <div class="form-check form-check-inline">
                                                    <input type="radio" name="course_type" id="both_course" value="paid"
                                                        class="form-check-input"
                                                        {{ old('course_type') == 2 ? 'checked' : '' }} required />
                                    ...
                                    <div class="col-lg-6 col-sm-12">
                                        <div class="mb-10">
                                            <label class="required form-label">Mentor</label>
                                            <div class="d-flex align-items-center">
                                                <select name="team_id" class="form-control" required>
                                                    ...
                                                    @foreach ($teams as $team)
                                                        <option value="{{ $team->id }}"
                                                            ...
                                                            {{ $team->name }} <!-- Change this field if needed -->
                                                        </option>
                                                    @endforeach
                                                </select>
                                            </div>
