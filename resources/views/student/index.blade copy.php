            ...
            <div class="container">
                <div class="herosection row">
                    <div class="herosection__left col-xl-7 col-lg-7 col-md-8">
                        ...
                        <h1 class="herosection__heading__first">Pakistan’s No.1 Online Learning Platform
                        </h1>
                        <p class="mb-2 text-start ">
                            Learn 21st-century skills, outperform competitors, and start earning. SkillSider is your gateway
                            to success in the digital world—unlock your future today!
                        </p>
                                ...
                                <div class="course-box d-flex ">
                                    <div class="product ">
                                        ...
                                        <div class="product-content">
                                            <div class="d-flex">
                                                <h6 class="course-title"> <a
                                                        href="{{ route('single.package', ['id' => $package->id]) }}">
                                                        <b class="pckg_title" > {{ $package->package_title }}</b> </a></h6>
                                            </div>
                                        ...
                                        py-2 mb-2"
                                         ...
                                         color: rgba(128, 128, 128, 0.942);">
                                                <div class="d-flex gap-2 align-items-center">
                                                    ...
                                                    <p style="font-size: 13px">{{ $courses->count() }} Courses</p>
                                                </div>
                                                ...
                                                <div class="d-flex gap-2 align-items-center">
                                                    <img src="{{ asset('studens-asset/assets/icons/icon-02.svg') }}"
                                                        alt="">
                                                    @if ($days > 0)
                                                        <p style="font-size: 13px">{{ $days }}d</p>
                                                    @endif
                                                    @if ($hours > 0)
                                                        <p style="font-size: 13px">{{ $hours }}hr</p>
                                                    @endif
                                                    @if ($Minutes > 0)
                                                        <p style="font-size: 13px">{{ $Minutes }}min</p>
                                                    @endif
                                                </div>
                                            ...
                                            <div>
                                                <ul class="packages-ul" style="font-size: 15px">

                                                    <li> <i class="fa-solid fa-check"></i> Live Q&amp;A Support</li>
                                                    <li> <i class="fa-solid fa-check"></i>100k+ Students Enrolled</li>
                ...
                <section class="skill-slider-section">
                    ...
                    <div class="row skill-slider-row">
                        <div class="lead-guru-box  ">
                            ...
                            <img src="{{ asset('home-icone/skillsider_students.png') }}" alt="" width="83px" height="80">
                        ...
                        <div class="lead-guru-box ">
                            {{-- <img src="{{ asset('studens-asset/assets/img/profit.png') }}" alt="" width="83"
                                height="80"> --}}
                                <img src="{{ asset('home-icone/skillsider_trainers.png') }}" alt="" width="83"
                                height="80">
                        ...
                        <div class="lead-guru-box ">
                            {{-- <img src="{{ asset('studens-asset/assets/img/investment.png') }}" alt=""
                               > --}}
                                <img src="{{ asset('home-icone/skillsider_earning.png') }}" alt=""  width="83" height="80">
...
var(--Secondary-gradiant-color) 100%);">
            <div class="container">
                <div class="text-center d-flex justify-content-between align-items-center flex-column">
                    <h1 class="section-heading">Meet Our Mentors</h1>
                        ...
                        <div class="row">
                            <div class="col-lg-6 col-md-6 d-flex">
                                <div class="certified-group-box  blur-border d-flex">
                                    <img src="{{ asset('studens-asset/assets//img/learning.png') }}" alt=""  class="why-skillsider-img">
                            ...
                            <div class="col-lg-6 col-md-6 d-flex">
                                <div class="certified-group-box  blur-border d-flex">
                                    <img src="{{ asset('studens-asset/assets//img/graduation.png') }}" alt=""  class="why-skillsider-img" >
                                    <p style="overflow-y: scroll;">
                            ...
                            <div class="col-lg-6 col-md-6 d-flex">
                                <div class="certified-group-box blur-border d-flex">
                                    <img src="{{ asset('studens-asset/assets//img/influencer.png') }}" alt="" 
                                    class="why-skillsider-img"   >
                                    <p style="overflow-y: scroll;">
        ...
        <div class="update-section-starter" style="padding-top:1px">
            <div class="container update-section">
                <div class="update-inform">
                    ...
                    <p>SKILLSIDER is not responsible for payment made against our products to anyone other than the official
                        account numbers given on our website.</p>
                </div>
            </div>
        </div>
        {{--        referral code modal --}}
