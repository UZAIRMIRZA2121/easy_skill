            ...
            <div class="d-flex flex-column flex-lg-row-fluid py-10">
                ...
                <div class="d-flex flex-center flex-column flex-column-fluid">
                    ...
                    <div class="w-lg-800px py-5 px-10 py-lg-5 pb-lg-10 px-lg-15 mx-auto card">
                        <!--begin::Form-->
                        <div class="">
                            <a href="{{ route('std.index') }}" class="text-muted fw-bolder" style="float: right">Back to
                                Home</a>
                        </div>
                        <!--begin::Heading-->
                        ...
                        <div class="  alert-success py-4 h1 text-center  mb-5">
                            ...
                            <div class="row mb-7">
                                ...
                                <div class="col-12 col-md-6">
                                    ...
                                    <x-input id="phone" class="form-control form-control-lg form-control-solid"
                                        type="number" name="phone" required value="{{ old('phone') }}"
                                    ...
                                    <div class="row">
                                        <div class="col-6 ">
                                            <x-input id="referral_code"
                                                ...
                                                name="referral_code" required placeholder="Enter Sponsor Code"
                            ...
                            <div class="row mb-7">
                                {{-- <div class="col-12  mb-7">
                                    ...
                                    <select class="form-select form-select-solid" name="state" data-control="select2"
                                        data-placeholder="Select an option" value="{{ old('state') }}">
                                        <option></option>
                                ...
                                <div class="mt-10 text-center">
                                    ...
                                    <div class="row mb-5 ">
                                        ...
                                        <div data-kt-buttons="true">
                                            ...
                                            <label
                                                class="btn  btn-outline-success btn-outline btn-outline-dashed btn-active-light-success d-flex flex-stack text-start p-6 mb-5 {{ $active}}    {{ $key === 0 ? '' : '' }}">
                                                <!--end::Description-->
                                ...
                                <div class="col-12 col-md-6 mb-7">
                                    ...
                                    <input type="button" class="btn btn-lg btn-success w-100 " data-bs-toggle="modal"
                                        data-bs-target="#referral_code_modal" value="Payment Method">
                                </div>
                                ...
                                <div class="col-12 col-md-6 mb-7">
                                    <label class="form-label fw-bolder text-dark fs-6">Transaction ID<span
                                            class="text-danger">*</span></label>
                                    <x-input id="payment_image" class="form-control form-control-lg form-control-solid"
                                        type="text" name="trxid" required placeholder="Enter your Transaction ID" />
                                    @error('trxid')
                                    <span class="text-danger">{{ $message }}</span>
                                    @enderror
                                </div>
                                <div class="col-12">
                                    ...
                                    <label class="form-label fw-bolder text-dark fs-6">
                                        Due to the nature of the services and business, there is a <span> <a
                                                href="{{ route('refund.policy') }}" target="_blank" class="text-danger"
                                                rel="noopener noreferrer">STRICT NO REFUND
                                                POLICY.</a> </span>
