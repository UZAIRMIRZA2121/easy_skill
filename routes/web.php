...
Route::get('/register-by/{referral_code}/{pckg?}', [UserController::class, 'register_by_referral_pckge'])->name('register.by.referal.pckge');
...
Route::middleware(['admin'])->prefix('admin')->group(function () {
    ...
    Route::get('/search-paid-users', [UserController::class, 'searchPaidUsers'])->name('search.paid.users');
    ...
    Route::get('/payment-request-management', [EarningController::class, 'payment_request_management'])->name('payment.request.withdrawal');
    Route::get('/payment-paid-management', [EarningController::class, 'payment_paid_management'])->name('payment.paid.withdraw');
    Route::get('/admin/payments/paid-payment', [EarningController::class, 'paid_payment_search'])->name('payments.paid-payment');
...
Route::middleware(['student'])->prefix('student')->group(function () {
    ...
    Route::get('Generator-link', [StudentController::class, 'generator_link'])->name('generate.link');
    ///-----Students--Controller---//
    Route::get('/dashboard', function () {
